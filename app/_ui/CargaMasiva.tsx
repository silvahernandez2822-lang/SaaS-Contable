        ...
        >
          <div className="flex max-h-[85vh] w-full max-w-2xl flex-col overflow-hidden rounded-xl border border-borde bg-superficie-elevada shadow-2xl">
            ...
            <div className="min-h-0 flex-1 overflow-auto p-5">
              {!puede ? (
                <div className="rounded-md border border-error/40 bg-error/8 p-4 text-[13px] text-texto">
                  ...
                  {estado && (
                    ...
                    >
                      ...
                      {r && r.errores.length > 0 && (
                        <div className="mt-3 max-h-72 overflow-auto rounded-md border border-borde">
                          <table className="w-full border-collapse text-[12px]">
                            <thead className="sticky top-0 bg-superficie text-left text-texto-suave">
                              <tr>
                            ...
                            <tbody>
                              {r.errores.map((e, i) => (
                                <tr key={`${e.numeroFila}-${i}`} className="border-t border-borde">
                                  <td className="px-3 py-2 font-semibold tabular-nums text-error-tinta">
                                    {e.numeroFila}
                                  </td>
                                  <td className="px-3 py-2 font-mono text-texto">{e.columna ?? '—'}</td>
